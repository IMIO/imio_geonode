...
# $POSTGRES psql -d geonode-imports -f '/docker-entrypoint-initdb.d/geonode.dump'
# $POSTGRES psql -d geonode-imports -f '/docker-entrypoint-initdb.d/geonode-imports.dump'
